...
freqs = my_cavity.get_mode_frequencies(1190, 50)
rel_modes = my_cavity.find_mode_density(26e9, 2e9)[1]
...
my_cavity.precalculate_antenna_mode_couplings(freq_mode_list=rel_modes)
stop_time = time.time()
elapsed_time = stop_time - start_time
print('It took ', elapsed_time, ' to calculate antenna mode couplings') 

# move the electron along the radius of the cavity and see how the antenna
# voltages change

r = np.linspace(0.001, radius - 0.001, 20)
...
plt.tight_layout()
plt.savefig('v26.pdf', bbox_inches='tight')
plt.close()
