...
def zslice_for_eposition(ex):
    ...
    np.savetxt('{2}/f25_zslice_er{0}_ez{1}_zhalflength_Er_real.txt'.format(ex[0],ex[2], directory),zslice[0])
...
def phislice_for_eposition(ex):
    ...
    np.savetxt('{2}/f25_phislice_er{0}_ez{1}_zhalflength_Er.txt'.format(ex[0],ex[2], directory),phislice[0])
    np.savetxt('{2}/f25_phislice_er{0}_ez{1}_zhalflength_Ephi.txt'.format(ex[0],ex[2], directory),phislice[1])
